...
describe('Event model', () => {
  ...
  it('has a virtual that gets a day of an event', () => {
    const event = new Event({
      dateOfEvent: new Date('2019-12-12T00:00:00')
    });
    expect(event.day).toEqual(12);
  });
  it('has a virtual that sets a day', () => {
    const event = new Event({
      dateOfEvent: new Date('2019-12-09T00:00:00')
    });
  ...
  it('has a virtual that gets a month', () => {
    const event = new Event({
      dateOfEvent: new Date('2019-12-12T00:00:00')
    });
  ...
  it('has a virtual that sets a month', () => {
    const event = new Event({
      dateOfEvent: new Date('2019-12-12T00:00:00')
    });
    event.month = 10;
  ...
  it('has a virtual that gets the year', () => {
    const event = new Event({
      dateOfEvent: new Date('2019-12-12T00:00:00')
    });
    expect(event.year).toEqual(2019);
  });
  it('has a virtual that sets the year', () => {
    const event = new Event({
      dateOfEvent: new Date('2019-12-12T00:00:00')
    });
    event.year = 2020;
